...
package org.swizframework.utils.services
{
	...
	public class URLRequestHelper implements IURLRequestHelper, ISwizAware
	{
										   ...
										   timeoutSeconds:uint=10, tries:uint=1, returnURLRequest:Boolean=false ): SwizURLRequest
		{
			...
			var dynamicURLRequest:SwizURLRequest = new SwizURLRequest( request, resultHandler, faultHandler, progressHandler, httpStatusHandler, eventArgs, useLoader, context, urlLoaderDataFormat, timeoutSeconds, tries, returnURLRequest );
